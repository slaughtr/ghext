...
public class FirebaseClipboardHistoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    View mView;
    Context mContext;

    public FirebaseClipboardHistoryViewHolder(View itemView) {
        super(itemView);
        Log.d("viewholder", "hi");
        mView = itemView;
    ...
    public void bindClipboardItem(String item) {
